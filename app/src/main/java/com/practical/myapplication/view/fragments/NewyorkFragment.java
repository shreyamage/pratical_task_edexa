...
public class NewyorkFragment extends Fragment implements SearchView.OnQueryTextListener{


    List<Employee> employeeList=new ArrayList<>();

    public NewyorkFragment(List<Employee> employeeList) {
    ...
    public void setAdapter(List<Employee> employeeList) {
        ...
        adapter=new AllDataAdapter(getContext(),employeeList,getResources().getString(R.string.newyork));
