...
public class LosAngelosFragment extends Fragment implements SearchView.OnQueryTextListener{


    List<Employee> employeeList=new ArrayList<>();

    public LosAngelosFragment(List<Employee> employeeList) {
    ...
    public void setAdapter(List<Employee> employeeList) {
        ...
        adapter=new AllDataAdapter(getContext(),employeeList,getResources().getString(R.string.losangelos));
